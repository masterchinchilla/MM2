...
import DayDetailAdmin from "./DayDetail.Admin.component";
import _ from "lodash";

export default class WeekMealPlanDetailAdmin extends Component {
  constructor(props) {
    super(props);
    this.state = {
      thisUserType: "author",
  ...
  handleDeleteRecord = (parentObj, objType) => {
    ...
    function createDefaultMealStateObj(mealType, dayOfWeek) {
      ...
      let thisMealParent = {
        ...
        thisMealsIngrdnts: [],
        // [createDefaultMealIngrdntStateObj(thisMealChild)],
        thisMealsMacrosBudget: {},
        thisRecipesIngrdnts: [],
      };
